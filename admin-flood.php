...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
            <td><button class='edit-button'><svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' fill='#f9b314' viewBox='0 0 256 256'>...</svg></button></td>
...
document.addEventListener("click", function (e) {
    if (e.target && e.target.classList.contains("edit-button")) {
        ...
        submitButton.innerHTML = "<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' fill='#008000' viewBox='0 0 256 256'>...</svg>";
