    ...
    <div class="weather-today">
      ...
      if ($currentWeather) {
        ...
        $svgPath = '';
          ...
          ';
          } elseif (strpos($description, 'scattered clouds') !== false) {
            $svgPath = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
            <defs>
              <linearGradient id="a" x1="16.5" y1="19.67" x2="21.5" y2="28.33" gradientUnits="userSpaceOnUse">
                <stop offset="0" stop-color="#fbbf24"/>
...
<div class="h-container">
  <div class="h-container-items">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="40" fill="#043a87" viewBox="0 0 256 256" style="position: relative; top: 35%;">
  ...
  <div class="h-container-items">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="40" fill="#83bbff" viewBox="0 0 256 256" style="position: relative; top: 35%;">
