...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateChart(selectedYear) {
      var data = {
        '2015': [
          { barangay: 'Abango', population: 1250 },
          { barangay: 'Amahit ', population: 1643 },
          { barangay: 'Balire ', population: 549 },
          { barangay: 'Balud ', population: 732 },
          { barangay: 'Bukid ', population: 1339 },
          { barangay: 'Bulod ', population: 631 },
          { barangay: 'Busay ', population: 985 },
          { barangay: 'Cabarasan ', population: 853 },
          { barangay: 'Cabolo-an ', population: 350 },
          { barangay: 'Calingcaguing ', population: 1296 },
          { barangay: 'Can-isak ', population: 758 },
          { barangay: 'Canomantag ', population: 712 },
          { barangay: 'Cuta ', population: 693 },
          { barangay: 'Domogdog ', population: 513 },
          { barangay: 'Duka ', population: 452 },
          { barangay: 'Guindaohan ', population: 733 },
          { barangay: 'Hiagsam ', population: 219 },
          { barangay: 'Hilaba ', population: 1055 },
          { barangay: 'Hinugayan ', population: 904 },
          { barangay: 'Ibag', population: 433 },
          { barangay: 'Minuhang', population: 1921 },
          { barangay: 'Minuswang', population: 831 },
          { barangay: 'Pikas', population: 1236 },
          { barangay: 'Pitogo', population: 440 },
          { barangay: 'Poblacion Dist. I', population: 1407 },
          { barangay: 'Poblacion Dist. II', population: 1064	 },
          { barangay: 'Poblacion Dist. III', population: 632 },
          { barangay: 'Poblacion Dist. IV', population: 976 },
          { barangay: 'Poblacion Dist. V', population: 1176 },
          { barangay: 'Poblacion Dist. VI', population: 1040 },
          { barangay: 'Pongso', population: 281 },
          { barangay: 'Roosevelt', population: 775 },
          { barangay: 'San Isidro', population: 914 },
          { barangay: 'San Roque', population: 488 },
          { barangay: 'Santa Rosa', population: 1688 },
          { barangay: 'Santarin', population: 1208 },
          { barangay: 'Tutug-an', population: 568 }
          
        ],
        '2020': [
          { barangay: 'Abango', population: 1373 },
          { barangay: 'Amahit ', population: 1802 },
          { barangay: 'Balire ', population: 698 },
          { barangay: 'Balud ', population: 752 },
          { barangay: 'Bukid ', population: 1463 },
          { barangay: 'Bulod ', population: 670 },
          { barangay: 'Busay ', population: 952 },
          { barangay: 'Cabarasan ', population: 889 },
          { barangay: 'Cabolo-an ', population: 377 },
          { barangay: 'Calingcaguing ', population: 981 },
          { barangay: 'Can-isak ', population: 927 },
          { barangay: 'Canomantag ', population: 754 },
          { barangay: 'Cuta ', population: 1142 },
          { barangay: 'Domogdog ', population: 503 },
          { barangay: 'Duka ', population: 514 },
          { barangay: 'Guindaohan ', population: 737 },
          { barangay: 'Hiagsam ', population: 219 },
          { barangay: 'Hilaba ', population: 1023 },
          { barangay: 'Hinugayan ', population: 905 },
          { barangay: 'Ibag', population: 396 },
          { barangay: 'Minuhang', population: 1942 },
          { barangay: 'Minuswang', population: 846 },
          { barangay: 'Pikas', population: 1457 },
          { barangay: 'Pitogo', population: 511 },
          { barangay: 'Poblacion Dist. I', population: 1416 },
          { barangay: 'Poblacion Dist. II', population: 1151	 },
          { barangay: 'Poblacion Dist. III', population: 618 },
          { barangay: 'Poblacion Dist. IV', population: 871 },
          { barangay: 'Poblacion Dist. V', population: 1106 },
          { barangay: 'Poblacion Dist. VI', population: 1152 },
          { barangay: 'Pongso', population: 308 },
          { barangay: 'Roosevelt', population: 890 },
          { barangay: 'San Isidro', population: 969 },
          { barangay: 'San Roque', population: 505 },
          { barangay: 'Santa Rosa', population: 1831 },
          { barangay: 'Santarin', population: 1291 },
          { barangay: 'Tutug-an', population: 556	}
        ],
      };

      var selectedData = data[selectedYear];
      var barangays = selectedData.map(entry => entry.barangay);
      var populations = selectedData.map(entry => entry.population);
